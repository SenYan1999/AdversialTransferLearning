...
class Trainer:
    def __init__(self, train_source_dataloader, training_target_dataloader, dev_source_dataloader, \
        ...
        self.domain_clf_optimzir = domain_clf_optimizer
    ...
    def train_epoch(self, epoch):
        ...
        for batch in self.train_source_dataloader:
            ...
            pbar_target.set_description('Epoch: %2d | Adversial Loss: %2.3f Domain Acc:' % (epoch, domain_loss.item(), domain_acc))
            pbar_target.update(1)
        pbar_target.close()
